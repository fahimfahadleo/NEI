...
public class LocalStorageProvider extends DocumentsProvider {
     ...
     */
    private final static String[] DEFAULT_ROOT_PROJECTION = new String[]{DocumentsContract.Root.COLUMN_ROOT_ID, DocumentsContract.Root.COLUMN_SUMMARY,
     ...
     */
    private final static String[] DEFAULT_DOCUMENT_PROJECTION = new String[]{DocumentsContract.Document.COLUMN_DOCUMENT_ID,
            DocumentsContract.Document.COLUMN_DISPLAY_NAME, DocumentsContract.Document.COLUMN_FLAGS, DocumentsContract.Document.COLUMN_MIME_TYPE, DocumentsContract.Document.COLUMN_SIZE,
    ...
    public Cursor queryRoots(final String[] projection) throws FileNotFoundException {
        ...
        if (TextUtils.equals(Environment.getExternalStorageState(), Environment.MEDIA_MOUNTED)) {
            ...
            row.add(Root.COLUMN_ICON, R.drawable.applogo);
        ...
        if (TextUtils.equals(storageState, Environment.MEDIA_MOUNTED) ||
            ...
            row.add(Root.COLUMN_ICON, R.drawable.menu);
